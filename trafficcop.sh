...
build_card_svg(){
  ...
  cat >"$1" <<EOF
<svg xmlns="http://www.w3.org/2000/svg" width="1000" height="550" viewBox="0 0 1000 550" font-family="DejaVu Sans, Noto Sans, Noto Sans CJK SC, WenQuanYi Micro Hei, Liberation Sans, Arial, sans-serif">
 <defs>
